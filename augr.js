...
app.get('/model/saturnv/texture/:texture_id', function(req, res){
...
app.get('/model/saturnv/:smodel_id', function(req, res){
    var smodel_id = req.params.smodel_id;
    res.sendFile(smodel_id, {root: dir[9]});
});
